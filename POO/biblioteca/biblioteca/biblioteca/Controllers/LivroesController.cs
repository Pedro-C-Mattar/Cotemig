...
namespace biblioteca.Controllers
{
    public class LivroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LivroId,Titulo,Sinopse,Categoria")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LivroId,Titulo,Sinopse,Categoria")] Livro livro)
        {
            if (id != livro.LivroId)
            {
                return NotFound();
