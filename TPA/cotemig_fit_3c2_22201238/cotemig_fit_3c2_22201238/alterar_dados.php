...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    function atualizarRegistro($conexao, $id, $nome, $email, $sexo, $endereco, $numero, $complemento, $bairro, $cidade, $uf, $modalidade) {
        $sql = "UPDATE aluno SET nome = '$nome', email = '$email', sexo = '$sexo', endereco = '$endereco', numero = '$numero', complemento = '$complemento', bairro = '$bairro', cidade = '$cidade', uf = '$uf', modalidade = '$modalidade' WHERE idAluno = $id";
